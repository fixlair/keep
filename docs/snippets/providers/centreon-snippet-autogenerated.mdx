...
- **api_token**: Centreon API Token (required: False, sensitive: True)
- **username**: Centreon username (required: False, sensitive: False)
- **password**: Centreon password (required: False, sensitive: True)
